...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 99; i <= 104; ++i) start[i] = 1;
		for (int i = 106; i <= 114; ++i) start[i] = 1;
	...
	void CheckLiteral() {
		switch (t.val) {
			...
			case "writeArray": t.kind = 37; break;
			case "write": t.kind = 38; break;
			case "writeRecordVal": t.kind = 39; break;
			case "writeString": t.kind = 40; break;
			case "switch": t.kind = 41; break;
			case "case": t.kind = 42; break;
			case "default": t.kind = 43; break;
			case "create": t.kind = 44; break;
			case "program": t.kind = 45; break;
			case "int": t.kind = 46; break;
			case "bool": t.kind = 47; break;
			case "string": t.kind = 48; break;
			case "init": t.kind = 49; break;
			case "constant": t.kind = 50; break;
			case "external": t.kind = 52; break;
			case "procedure": t.kind = 53; break;
			default: break;
		}
	}
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 3:
				if (ch >= ' ' && ch <= '!' || ch >= '$' && ch <= '&' || ch >= '(' && ch <= '9' || ch >= '<' && ch <= '[' || ch >= ']' && ch <= '_' || ch >= 'a' && ch <= '{' || ch >= '}' && ch <= '~' || ch == 163 || ch == 194) {AddCh(); goto case 4;}
				else {goto case 0;}
			case 4:
				if (ch == 39) {AddCh(); goto case 5;}
				else if (ch >= ' ' && ch <= '!' || ch >= '$' && ch <= '&' || ch >= '(' && ch <= '9' || ch >= '<' && ch <= '[' || ch >= ']' && ch <= '_' || ch >= 'a' && ch <= '{' || ch >= '}' && ch <= '~' || ch == 163 || ch == 194) {AddCh(); goto case 4;}
				else {goto case 0;}
			case 5:
				{t.kind = 3; break;}
			case 6:
			...
			case 30:
				...
				else if (ch == 'n') {AddCh(); goto case 35;}
				else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 31:
				recEnd = pos; recKind = 1;
			...
			case 32:
				...
				else if (ch == 't') {AddCh(); goto case 37;}
				else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 33:
			...
			case 37:
				...
				else if (ch == 'r') {AddCh(); goto case 40;}
				else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 38:
				recEnd = pos; recKind = 1;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 1;}
			...
			case 39:
				...
				else if (ch == 'l') {AddCh(); goto case 41;}
				else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 40:
				recEnd = pos; recKind = 1;
			...
			case 42:
				recEnd = pos; recKind = 1;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'm' || ch >= 'o' && ch <= 'z') {AddCh(); goto case 1;}
				else if (ch == 'n') {AddCh(); goto case 43;}
				else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 43:
				recEnd = pos; recKind = 1;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'f' || ch >= 'h' && ch <= 'z') {AddCh(); goto case 1;}
				else if (ch == 'g') {AddCh(); goto case 44;}
				else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 44:
				recEnd = pos; recKind = 1;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 1;}
